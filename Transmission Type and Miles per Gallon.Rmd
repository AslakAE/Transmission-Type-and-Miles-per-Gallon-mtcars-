...
## Executive Summary
The report shows that features of a car model, such as transmission type, number of cylinders and horsepower, can accurately predict the consumption (multivariable linear regression model). 
...
The anova test shows (details in appendix) that the **miles per gallon consumption** predicted by **transmission type** should include the features: **number of cylinders** and **horsepower**. The anova test shows significance for the inclusion of these features.
